        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-5 text-lg leading-8 text-gray-600">
            <p>
              {isFr ? (
                <>
                  <CharisName /> est née dans un cadre simple, avec la
                  conviction que l’éducation pouvait devenir un puissant moyen
                  de transformation des personnes, des familles et des
                  communautés.
                </>
              ) : (
                <>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {[
              ...
              <div key={item} className="rounded-2xl bg-blue-900 p-6 font-bold">
                {item}
              </div>
            ))}
          </div>
