...
export default async function SchoolLifePage({ params }: PageProps) {
  ...
  const activities = isFr
    ...
    : [
      ...
      {
        title: "ICT",
        description: "Developing digital literacy and computer skills.",
      },
      {
        title: "Music",
        description:
      ...
      {
        title: "Sports",
        description: "Promoting health, discipline and teamwork.",
      },
      {
        title: "Arts & Creativity",
        description: "Drawing, painting, decoration and creative expression.",
      },
      {
        title: "Leadership",
        description:
      ...
      <section className="bg-white px-6 py-20">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <h2 className="mt-3 text-4xl font-bold text-blue-950">
            {isFr ? "Une éducation globale" : "A Whole-Child Education"}
          </h2>
      ...
      <section className="bg-gray-100 px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-4xl font-bold text-blue-950">
              {isFr ? "Développer tous les talents" : "Developing Every Talent"}
            </h2>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item} className="rounded-xl bg-blue-900 p-5 font-bold">
                {item}
              </div>
            ))}
          </div>
